...
Before starting work, check the [existing issues](https://github.com/daiqiongzhao-bit/Juju/issues). For anything beyond a trivial fix, open an issue first to discuss the approach. This avoids wasted effort on changes that conflict with the project's direction.
...
[Open an issue](https://github.com/daiqiongzhao-bit/Juju/issues/new/choose) with:
...
Do **not** open a public issue. Use [GitHub Private Vulnerability Reporting](https://github.com/daiqiongzhao-bit/Juju/security/advisories/new) instead. See [`SECURITY.md`](SECURITY.md) for details.

---

## Questions?

If something in this guide is unclear or you're unsure whether a contribution fits, open a thread in [Discussions](https://github.com/daiqiongzhao-bit/Juju/discussions) or comment on the relevant issue. We're happy to help.

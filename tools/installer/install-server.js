#!/usr/bin/env node
/**
 * Juju Web Installer - temporary setup server.
...
export function renderEnvFile(env) {
  const lines = ['# Generated by Juju Installer'];
      ...
      const result = await new Promise((resolve, reject) => {
        ...
        const proxyReq = http.request(opts, proxyRes => {
          ...
          proxyRes.on('end', () => {
            ...
            catch { resolve({ status: proxyRes.statusCode, body: { error: 'Invalid response from Juju' } }); }
          });
        });

/**
 * Modul: Nav Icons
 * Zweck: Eigener monoliniger Icon-Set für die Juju-Navigation (1.6px Strich, 24×24).
...
export const NAV_ICONS = {
  ...
  'gift': () => makeSvg(
    e('path', { d: 'M5 9.5h14M12 9.5v10M8.2 9.5C8.2 7.6 9.8 6.5 12 6.5s3.8 1.1 3.8 3' }),
    e('path', { d: 'M5 9.5c1.6.7 1.6 2.5 0 3.2M19 9.5c-1.6.7-1.6 2.5 0 3.2' }),
    e('path', { d: 'M9.2 6.5 12 4l2.8 2.5M9.2 6.5l2.8-1.4 2.8 1.4' }),
  ),

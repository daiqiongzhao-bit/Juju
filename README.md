<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/daiqiongzhao-bit/Juju/"><strong>Live demo &amp; screenshots</strong></a> &nbsp;·&nbsp;
...
<div align="center">
  ...
  <br><br>
  <a href="https://github.com/daiqiongzhao-bit/Juju/">See every screen on github.com/daiqiongzhao-bit/Juju →</a>
</div>
...
| | Module | In one line |
|:---:|---|---|
| ![tasks](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/tasks.png) | **Tasks** | Kanban board with deadlines, priorities, subtasks, tags, recurring schedules and multi-member assignment. |
| ![shopping](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/shopping.png) | **Shopping** | Collaborative lists grouped by aisle and ordered to match your shop, with swipe gestures and one-tap import from the meal plan. |
| ![meals](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/meals.png) | **Meals** | Weekly drag-and-drop planner with a recipe sidebar and direct export to the shopping list. |
| ![recipes](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/recipes.png) | **Recipes** | Create, duplicate and scale recipes, then pre-fill meal slots, send the ingredients straight to a shopping list, or save any planned meal. Optionally mirrors a self-hosted Mealie instance read-only. |
| ![pantry](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/pantry.png) | **Pantry** | What is actually in the house: amount, storage location and best-before date, with expiry and low-stock filters and a two-way handover with the shopping list. |
| ![calendar](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/calendar.png) | **Calendar** | Two-way sync with Google and CalDAV, ICS subscriptions, recurring events, holiday overlays and shared visibility. |
| ![documents](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/documents.png) | **Documents** | Upload, tag, preview and organize family files, with optional WebDAV or Google Drive storage. |
| ![budget](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/budget.png) | **Budget** | Income, expenses, accounts, loans, subscriptions and per-category planning, with a personal mode. |
| ![housekeeping](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/housekeeping.png) | **Housekeeping** | Manage household staff: schedules, check-in/out, daily or hourly billing, chores and supply requests. |
| ![rewards](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/rewards.png) | **Rewards** | Points on tasks credit assigned members, with a configurable default value for new tasks, a parent-approved catalog and an auditable ledger. |
| ![health](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/health.png) | **Health** | Per-member vitals, medications, labs, activity and menstrual cycle tracking, with trend charts. |
| ![notes](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/notes.png) | **Notes &amp; Contacts** | Colored Markdown sticky notes plus a contact directory with CardDAV sync and vCard import/export. |
| ![birthdays](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/birthdays.png) | **Birthdays** | Birthday tracker with automatic calendar events, age display and reminders. |
| ![family](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/family.png) | **Family** | Member profiles with roles, photos and contact details, synced to Contacts and Birthdays. New members join through an invite link and pick their own password. |
| ![reminders](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/reminders.png) | **Reminders** | Task and calendar reminders via in-app badges, opt-in Web Push and household Gotify/ntfy channels. |
| ![api-tokens](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/api-tokens.png) | **API Tokens** | Bearer / X-API-Key tokens with an OpenAPI 3.0 spec and a built-in MCP endpoint for AI agents. |
| ![backup](https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docs/icons/backup.png) | **Backup** | Manual and scheduled database backup/restore with pre-restore rollback and optional WebDAV upload. |
...
```bash
curl -O https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/docker-compose.yml
curl -O https://raw.githubusercontent.com/daiqiongzhao-bit/Juju/main/.env.example
...
New home: **https://github.com/daiqiongzhao-bit/Juju/** · Questions? Open a [discussion](https://github.com/daiqiongzhao-bit/Juju/discussions).
